...
class ClientCategory(models.Model):
    ...
    clientes = models.ManyToManyField(Client, related_name='categorias', blank=True, verbose_name="👥 Clientes")
    
    class Meta:
        verbose_name = "🏷️ Categoría de Cliente"
        verbose_name_plural = "🏷️ Categorías de Clientes"
