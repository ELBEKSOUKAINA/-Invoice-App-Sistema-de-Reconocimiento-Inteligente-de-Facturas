...
class Product(models.Model):
    ...
    codigo = models.CharField(max_length=50, unique=True, verbose_name="🏷️ Código")
...
class ProductDetail(models.Model):
    ...
    garantia = models.IntegerField(default=12, verbose_name="🛡️ Meses de garantía")
...
class ProductCategory(models.Model):
    nombre = models.CharField(max_length=50, verbose_name="🏷️ Categoría")
    productos = models.ManyToManyField(Product, related_name='categorias', blank=True, verbose_name="📦 Productos")
    
    class Meta:
        verbose_name = "🏷️ Categoría de Producto"
        verbose_name_plural = "🏷️ Categorías de Productos"
